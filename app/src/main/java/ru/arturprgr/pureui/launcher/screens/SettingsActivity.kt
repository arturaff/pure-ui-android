        ...
        binding.apply {
            ...
            selectFont.onItemSelectedListener = object : OnItemSelectedListener {
                override fun onItemSelected(
                    ...
                    when (position) {
                        0 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/advent_pro.ttf")
                        ...
                        1 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/alegreya.ttf")
                            sharedPreferences.edit().putInt("selectFont", R.style.alegreya)
                                .putString("fontTypeface", "fonts/alegreya.ttf").apply()
                        }

                        2 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/amatic_sc.ttf")
                            sharedPreferences.edit().putInt("selectFont", R.style.amatic_sc)
                                .putString("fontTypeface", "fonts/amatic_sc.ttf").apply()
                        }

                        3 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/bad_script.ttf")
                        ...
                        4 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/caveat.ttf")
                            sharedPreferences.edit().putInt("selectFont", R.style.caveat)
                                .putString("fontTypeface", "fonts/caveat.ttf").apply()
                        }

                        5 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/comfortaa.ttf")
                            sharedPreferences.edit().putInt("selectFont", R.style.comfotaa)
                                .putString("fontTypeface", "fonts/comfortaa.ttf").apply()
                        }

                        6 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/jost.ttf")
                            sharedPreferences.edit().putInt("selectFont", R.style.jost)
                                .putString("fontTypeface", "fonts/jost.ttf").apply()
                        }

                        7 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/jura.ttf")
                            sharedPreferences.edit().putInt("selectFont", R.style.jura)
                                .putString("fontTypeface", "fonts/jura.ttf").apply()
                        }

                        8 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/marck_script.ttf")
                        ...
                        9 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/merriweather.ttf")
                        ...
                        10 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/nunito.ttf")
                            sharedPreferences.edit().putInt("selectFont", R.style.nunito)
                                .putString("fontTypeface", "fonts/nunito.ttf").apply()
                        }

                        11 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/pacifico.ttf")
                            sharedPreferences.edit().putInt("selectFont", R.style.pacifico)
                                .putString("fontTypeface", "fonts/pacifico.ttf").apply()
                        }

                        12 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/pangolin.ttf")
                            sharedPreferences.edit().putInt("selectFont", R.style.pangolin)
                                .putString("fontTypeface", "fonts/pangolin.ttf").apply()
                        }

                        13 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/poiret_one.ttf")
                        ...
                        14 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/sofia_sans.ttf")
                        ...
                        15 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/ubuntu.ttf")
                            sharedPreferences.edit().putInt("selectFont", R.style.ubuntu)
                                .putString("fontTypeface", "fonts/ubuntu.ttf").apply()
                        }

                        16 -> {
                            label.typeface = Typeface.createFromAsset(this@SettingsActivity.assets, "fonts/yanone_kaffeesatz.ttf")
            ...
            selectIconRound.progress = sharedPreferences.getInt("selectIconRound", 75)
            selectIconSize.progress = sharedPreferences.getInt("selectIconSize", 150)
        }
    }
